...
M.language_to_filetype = function(language)
    ...
    return language_to_ft_map[language] or language:lower()
end

---@param language string
---@return string
M.get_language_icon = function(language)
    local default_icon = ''
    if not devicons_present then
        return default_icon
    end

    local filetype = M.language_to_filetype(language)
    local icon, _ = devicons.get_icon(filetype, { default = true })
